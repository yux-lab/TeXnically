...
if __name__ == "__main__":
    ...
    st.title("LaTeX OCR")
    st.markdown(
        "Convert images of equations to corresponding LaTeX code.\n\nThis is based on the `TeXnically` module. Check it out [![github](https://img.shields.io/badge/TeXnically-visit-a?style=social&logo=github)](https://github.com/yux-lab/TeXnically)"
    )
